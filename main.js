...
function initTranslationSystem() {
    ...
    const dict = {
        'en': {
            ...
            "bio-fp-p1": "Francesco Pontillo is a sound engineer and producer. He runs Tiny Temple Studio, which carries his name, and looks after the production and artistic direction of the projects that come through the studio.",
            ...
            "bio-am-p6": "Alongside soundtrack work and special projects for theatre, screen and dance (&ldquo;Semi-Interrati&rdquo; and several film festivals), Andrea is active in his creative community, co-running the Tiny Temple Studio recording studio together with producer Francesco Pontillo and curating independent music festivals such as Piano Frequency Fest, Orbettino Fest and Comete Fest, with new projects planned for 2026.",
        ...
        'it': {
            ...
            "bio-fp-p1": "Francesco Pontillo è sound engineer e produttore. Guida Tiny Temple Studio, che porta il suo nome, e segue la produzione e la direzione artistica dei progetti che passano dallo studio.",
            ...
            "bio-am-p6": "Accanto alla composizione di colonne sonore e progetti speciali per il teatro, l'audiovisivo e la danza (&ldquo;Semi-Interrati&rdquo; e diversi festival cinematografici), Andrea è attivo nella sua comunità creativa, co-gestendo lo studio di registrazione Tiny Temple Studio insieme al produttore Francesco Pontillo e curando festival musicali indipendenti come Piano Frequency Fest, Orbettino Fest e Comete Fest, con nuovi progetti in programma per il 2026.",
