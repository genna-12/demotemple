...
function initTranslationSystem() {
    ...
    const dict = {
        'en': {
            ...
            "form-privacy-3": "Details on how we handle messages are in the",
            "form-privacy-link2": "legal notice",
            "nl-form-h": "How we handle messages sent through the contact form",
            "nl-form-p1": "The data you enter in the form (name or artist name, email address, type of service and message text) is used solely to answer your enquiry. The legal basis is the performance of pre-contractual measures taken at your request (art. 6.1.b GDPR): your consent is not required and will not be asked for.",
            "nl-form-p2": "Delivery is handled by <strong>Web3Forms (Web3Creative)</strong>, a provider based in India acting as data processor, which keeps messages for <strong>3 years</strong> from submission, after which they are deleted automatically. The transfer of data outside the European Economic Area relies on the <strong>Standard Contractual Clauses</strong> approved by the European Commission. Web3Forms uses sub-processors for infrastructure and spam filtering.",
            "nl-form-p3": "A copy of the message also reaches the owner's mailbox, where it is kept for as long as needed to handle the enquiry and in any case no longer than 24 months from the last contact, unless the enquiry leads to a contract.",
            "nl-form-p4": "You can ask for access, rectification or erasure of your data at any time by writing to <a href=\"mailto:tinytempleproduction@gmail.com\">tinytempleproduction@gmail.com</a>.",
            "nl-cookie-h": "External content and consent",
            "nl-cookie-p1": "This site uses no profiling, analytics or advertising cookies. The only data stored on your device serves the site's own operation (chosen language, form spam protection, player consent) and requires no consent.",
            "nl-cookie-p2": "The only third-party content is the Spotify player on the Portfolio page, which is <strong>not loaded automatically</strong>: it stays inactive until you enable it with a click. You can withdraw your consent at any time through the &ldquo;External content consent&rdquo; link in the footer.",
            "bio-eyebrow": "The team",
            "bio-btn": "Bio",
            "bio-fp-title": "Founder e Sound Engineer",
            "bio-fp-role": "Production and artistic direction",
            "bio-fp-p1": "Francesco Pontillo is a sound engineer, music producer, mix and mastering engineer, and the founder of Tiny Temple Studio, an audio production and post-production studio opened in 2025.",
            "bio-fp-p2": "His path in audio began with Sound Engineering studies at Naive Studio Recording, under Francesco De Benedictis. After graduating he joined Deposito Zero Studios in Forlì, helping to develop the studio and its music production work.",
            "bio-fp-p3": "He is one of the founders of Live Zero, a live session format created within Deposito Zero Studios, which over the years has hosted some of the most interesting names on the Italian music scene, among them Tananai, Giorgio Poi, Mecna, Massimo Pericolo, Giungla, Gomma and Gazebo Penguins. The project grew out of the idea of giving live music back its most essential form, through recordings and video productions crafted down to the last detail.",
            "bio-fp-p4": "Alongside his studio work, Francesco built up long experience as a live musician with España Circo Este, a band he spent around ten years touring with across Italian and European stages, playing hundreds of concerts and taking his music overseas as far as Austin, Texas.",
            "bio-fp-p5": "Over the years he has also worked with a number of independent artists and projects, among them the collective Corner in Bloom, for which he handles production and the shaping of its sonic aesthetic.",
            "bio-fp-p6": "With Tiny Temple Studio he pursues an approach to music production built on listening, sonic research and a direct relationship with the artist. His work spans recording and production, mixing and mastering, always aiming to bring out the musical identity of each project rather than override it.",
            "bio-fp-p7": "Every technical choice is at the service of the music: supporting artists along their own path, helping give shape to the sound that represents them.",
            "bio-fp-s1-h": "Artists he has worked with",
            "bio-fp-s2-h": "Live Zero &middot; live session",
            "bio-am-title": "Multi-instrumentalist",
            "bio-am-role": "Arrangement",
            "bio-am-p1": "Andrea is an Italian composer and multi-instrumentalist (violin, guitar, accordion) with a conservatory degree in piano, pursuing musical research that brings together contemporary writing, cinematic atmospheres and a strong focus on live sound design.",
            "bio-am-p2": "Active since 2010, he has taken his own projects to festivals and cultural venues across Italy and Europe – playing notable stages such as Lowlands, Paaspop, Home Festival, Carroponte and Sherwood – and has appeared on national radio and television.",
            "bio-am-p3": "His artistic path is driven by a deep commitment to translating the emotions and atmospheres of nature into music. Over the years his work has widened into several fields, including national television and radio appearances (RAI prime time on &ldquo;Tutto Può Succedere&rdquo; and &ldquo;Caterpillar&rdquo; on Radio 2) and live soundtrack performances, among them the scoring of the feature film &ldquo;Kiki's Delivery Service&rdquo; for CineSuono Festival, &ldquo;Nosferatu&rdquo; (1922) for Cinema di Misura and Marion Revol's short film &ldquo;Monsieur Martinet&rdquo;.",
            "bio-am-p4": "His discography includes the album &ldquo;L'incredibile Viaggio&rdquo; (Blue Spiral Records / Believe, 2021) and a second album, &ldquo;Calanchi&rdquo; (Tsck Records, 2024), presented on a tour of more than 70 concerts across Italy, the United Kingdom and the United States, including a live performance on &ldquo;Piazza Verdi&rdquo; for Radio Rai 3. Since 2022 he has also worked as resident musician and composer for the theatre company Teatro del Drago.",
            "bio-am-p5": "Alongside awards in composition competitions – winning Roberto Cacciapaglia's &ldquo;The Future&rdquo; and taking second place at Piano City Napoli – he has written original music for social and environmental projects such as FLOES, composed the official soundtrack for the Sedicicorto International Film Festival, and scored documentaries, short films and features, including &ldquo;L'ultima fila – storia di Pippo Fava&rdquo; (La 7), Luca Zambianchi's latest film (due in 2027) and Matteo Lolletti's &ldquo;Interno 18&rdquo;.",
            "bio-am-p6": "Alongside soundtrack work and special projects for theatre, screen and dance (&ldquo;Semi-Interrati&rdquo; and several film festivals), Andrea is active in his creative community, working with the Tiny Temple Studio recording studio run by producer Francesco Pontillo and curating independent music festivals such as Piano Frequency Fest, Orbettino Fest and Comete Fest, with new projects planned for 2026.",
            "footer-legal-note": "Tiny Temple Studio is the name under which Francesco Pontillo, a self-employed professional, carries out his activity. The professionals listed on this site work with the studio as independent self-employed contractors.",
            ...
            "nl-s1-h": "Site owner",
            "nl-s1-p1": "Tiny Temple Studio — Francesco Pontillo, self-employed professional.<br>Studio: Via Forreta 2, Forlì (FC), Italy.<br>Tax domicile: Piazzale della Commenda 26, 47121 Forlì (FC), Italy.<br>VAT 04337140406<br>Email: <a href=\"mailto:tinytempleproduction@gmail.com\">tinytempleproduction@gmail.com</a>",
            "nl-s2-h": "Nature of the business",
            "nl-s2-p1": "Tiny Temple Studio is the name under which Francesco Pontillo, a VAT-registered self-employed professional, carries out his activity. It is not a company, nor a professional partnership, nor a business entered in the Italian Register of Companies.",
            "nl-s2-p2": "The professionals listed on this site work with the studio as independent self-employed contractors, each with their own tax position. There is no partnership or association between them. All contracts for the services offered are entered into with Francesco Pontillo, sole owner of the business.",
            ...
            "ponz-title": "Founder e Sound Engineer",
            "ponz-role": "Production and artistic direction",
            "andrea-title": "Multi-instrumentalist",
            "andrea-role": "Arrangement",
        ...
        'it': {
            ...
            "form-privacy-3": "Dettagli su come trattiamo i messaggi nelle",
            "form-privacy-link2": "note legali",
            "nl-form-h": "Come trattiamo i messaggi inviati dal modulo di contatto",
            "nl-form-p1": "I dati che inserisci nel modulo (nome o nome d'arte, indirizzo email, tipo di servizio e testo del messaggio) sono utilizzati esclusivamente per rispondere alla tua richiesta. La base giuridica è l'esecuzione di misure precontrattuali adottate su tua richiesta (art. 6.1.b GDPR): non è richiesto il tuo consenso e non ti verrà chiesto.",
            "nl-form-p2": "L'invio è gestito da <strong>Web3Forms (Web3Creative)</strong>, fornitore con sede in India, che agisce come responsabile del trattamento e che conserva i messaggi per <strong>3 anni</strong> dall'invio, con cancellazione automatica. Il trasferimento dei dati fuori dallo Spazio Economico Europeo avviene sulla base delle <strong>Clausole Contrattuali Standard</strong> approvate dalla Commissione Europea. Web3Forms si avvale di sub-responsabili per l'infrastruttura e per il filtraggio dello spam.",
            "nl-form-p3": "Una copia del messaggio raggiunge inoltre la casella di posta del titolare, dove viene conservata per il tempo necessario a gestire la richiesta e comunque non oltre 24 mesi dall'ultimo contatto, salvo che dalla richiesta nasca un rapporto contrattuale.",
            "nl-form-p4": "Puoi in qualsiasi momento chiedere accesso, rettifica o cancellazione dei tuoi dati scrivendo a <a href=\"mailto:tinytempleproduction@gmail.com\">tinytempleproduction@gmail.com</a>.",
            "nl-cookie-h": "Contenuti esterni e consenso",
            "nl-cookie-p1": "Il sito non utilizza cookie di profilazione, statistiche o pubblicità. Gli unici dati salvati sul tuo dispositivo servono al funzionamento del sito (lingua scelta, protezione anti-spam del modulo, consenso al player) e non richiedono consenso.",
            "nl-cookie-p2": "L'unico contenuto di terze parti è il player Spotify nella pagina Portfolio, che <strong>non viene caricato automaticamente</strong>: resta inattivo finché non lo attivi tu con un clic. Puoi revocare il consenso in qualsiasi momento dal link &ldquo;Consenso contenuti esterni&rdquo; nel piè di pagina.",
            "bio-eyebrow": "Il team",
            "bio-btn": "Bio",
            "bio-fp-title": "Founder e Sound Engineer",
            "bio-fp-role": "Produzione e direzione artistica",
            "bio-fp-p1": "Francesco Pontillo è sound engineer, produttore musicale, mix e mastering engineer e fondatore di Tiny Temple Studio, studio di produzione e post-produzione audio nato nel 2025.",
            "bio-fp-p2": "Il suo percorso nel mondo dell'audio inizia con gli studi di Sound Engineering presso Naive Studio Recording, sotto la guida di Francesco De Benedictis. Dopo il diploma entra a far parte di Deposito Zero Studios di Forlì, contribuendo allo sviluppo dello studio e alla sua attività di produzione musicale.",
            "bio-fp-p3": "È tra i fondatori di Live Zero, format di live session ideato all'interno di Deposito Zero Studios, che negli anni ha ospitato alcuni dei nomi più interessanti della scena musicale italiana, tra cui Tananai, Giorgio Poi, Mecna, Massimo Pericolo, Giungla, Gomma e Gazebo Penguins. Il progetto nasce con l'idea di restituire la musica dal vivo nella sua forma più essenziale, attraverso registrazioni e produzioni video curate in ogni dettaglio.",
            "bio-fp-p4": "Parallelamente all'attività in studio, Francesco sviluppa una lunga esperienza come musicista live con gli España Circo Este, band con la quale percorre per circa dieci anni i palchi italiani ed europei, collezionando centinaia di concerti e portando la propria esperienza musicale anche oltre oceano, fino ad Austin, in Texas.",
            "bio-fp-p5": "Nel corso degli anni collabora inoltre con diversi artisti e progetti indipendenti, tra cui il collettivo Corner in Bloom, per il quale si occupa di produzione e cura dell'estetica sonora.",
            "bio-fp-p6": "Con Tiny Temple Studio porta avanti una visione della produzione musicale fondata sull'ascolto, sulla ricerca sonora e sul rapporto diretto con l'artista. Il suo lavoro spazia dalla registrazione alla produzione, dal mix al mastering, con l'obiettivo di valorizzare l'identità musicale di ogni progetto senza mai stravolgerla.",
            "bio-fp-p7": "Ogni scelta tecnica è al servizio della musica: accompagnare l'artista nel proprio percorso, contribuendo a dare forma al suono che lo rappresenta.",
            "bio-fp-s1-h": "Artisti con cui ha collaborato",
            "bio-fp-s2-h": "Live Zero &middot; live session",
            "bio-am-title": "Polistrumentista",
            "bio-am-role": "Arrangiamento",
            "bio-am-p1": "Andrea è un compositore e polistrumentalista italiano (violino, chitarra, fisarmonica) con una laurea di conservatorio in pianoforte, che porta avanti una ricerca musicale tesa a combinare scrittura contemporanea, suggestioni cinematografiche e una forte attenzione al sound design dal vivo.",
            "bio-am-p2": "Attivo dal 2010, ha portato i suoi progetti originali in numerosi festival e spazi culturali in Italia e in Europa – calcando palchi di rilievo come Lowlands, Paaspop, Home Festival, Carroponte e Sherwood – ed è apparso in programmi radiofonici e televisivi di rilievo nazionale.",
            "bio-am-p3": "Il suo percorso artistico è guidato da una profonda dedizione nel tradurre in musica le emozioni e le suggestioni della natura. Nel corso degli anni il suo lavoro si è ampliato in diversi ambiti, comprese partecipazioni televisive e radiofoniche nazionali (come in prima serata RAI in &ldquo;Tutto Può Succedere&rdquo; e a &ldquo;Caterpillar&rdquo; su Radio 2) e performance di colonne sonore dal vivo, tra cui la sonorizzazione del lungometraggio &ldquo;Kiki – Consegne a domicilio&rdquo; per il CineSuono Festival, &ldquo;Nosferatu&rdquo; (1922) per Cinema di Misura e il cortometraggio &ldquo;Monsieur Martinet&rdquo; di Marion Revol.",
            "bio-am-p4": "La sua discografia include l'album &ldquo;L'incredibile Viaggio&rdquo; (Blue Spiral Records / Believe, 2021) e il secondo album &ldquo;Calanchi&rdquo; (Tsck Records, 2024), presentato con un tour di oltre 70 concerti tra Italia, Regno Unito e Stati Uniti, comprendendo una performance in diretta a &ldquo;Piazza Verdi&rdquo; su Radio Rai 3. Dal 2022 lavora inoltre come musicista residente e compositore per la compagnia teatrale Teatro del Drago.",
            "bio-am-p5": "Accanto ai riconoscimenti in concorsi di composizione – come la vittoria a &ldquo;The Future&rdquo; di Roberto Cacciapaglia e il secondo posto a Piano City Napoli – ha composto musiche originali per progetti sociali e ambientali come FLOES, ha realizzato la colonna sonora ufficiale per il Sedicicorto International Film Festival e ha scritto colonne sonore per documentari, cortometraggi e lungometraggi, tra cui &ldquo;L'ultima fila – storia di Pippo Fava&rdquo; (La 7), l'ultimo film di Luca Zambianchi (uscita prevista per il 2027) e &ldquo;Interno 18&rdquo; di Matteo Lolletti.",
            "bio-am-p6": "Accanto alla composizione di colonne sonore e progetti speciali per il teatro, l'audiovisivo e la danza (&ldquo;Semi-Interrati&rdquo; e diversi festival cinematografici), Andrea è attivo nella sua comunità creativa, collaborando con lo studio di registrazione Tiny Temple Studio del produttore Francesco Pontillo e curando festival musicali indipendenti come Piano Frequency Fest, Orbettino Fest e Comete Fest, con nuovi progetti in programma per il 2026.",
            "footer-legal-note": "Tiny Temple Studio è il nome con cui Francesco Pontillo, libero professionista, esercita la propria attività. I professionisti indicati sul sito collaborano in qualità di lavoratori autonomi indipendenti.",
            "footer-privacy": "Privacy Policy",
            "footer-cookie": "Cookie Policy",
            ...
            "nl-s1-p1": "Tiny Temple Studio — Francesco Pontillo, libero professionista.<br>Studio: Via Forreta 2, Forlì (FC).<br>Domicilio fiscale: Piazzale della Commenda 26, 47121 Forlì (FC).<br>P.IVA 04337140406<br>Email: <a href=\"mailto:tinytempleproduction@gmail.com\">tinytempleproduction@gmail.com</a>",
            "nl-s2-h": "Natura dell'attività",
            "nl-s2-p1": "Tiny Temple Studio è il nome sotto cui Francesco Pontillo, libero professionista titolare di partita IVA, esercita la propria attività. Non si tratta di una società, né di un'associazione professionale, né di un'impresa iscritta al Registro delle Imprese.",
            "nl-s2-p2": "I professionisti indicati sul sito collaborano con lo studio in qualità di lavoratori autonomi indipendenti, ciascuno con la propria posizione fiscale. Non sussiste fra loro alcun vincolo societario o associativo. Tutti i rapporti contrattuali relativi ai servizi offerti sono conclusi con Francesco Pontillo, unico titolare dell'attività.",
            ...
            "about-text": "Tiny Temple Studio è una casa di produzione audio indipendente. Sviluppiamo artisti e progetti musicali attraverso produzione, direzione artistica e lavoro sul suono, collaborando con professionisti della fotografia e video per costruire un progetto completo e riconoscibile. Partiamo dall'artista, dalle sue idee e dal suo modo di raccontarsi. Non imponiamo formule: lavoriamo per valorizzare ciò che lo rende unico.",
            ...
            "ponz-title": "Founder e Sound Engineer",
            "ponz-role": "Produzione e direzione artistica",
            "andrea-title": "Polistrumentista",
            "andrea-role": "Arrangiamento",
